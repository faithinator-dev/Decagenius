...
if (!process.env.GEMINI_API_KEY) {
  console.warn(
    "WARNING: GEMINI_API_KEY is not set in the .env file. The AI agent will not be functional.",
  );
}
...
const agents = [
  {
    ...
    description:
      "Crafts professional resumes and builds simple web pages. Upload your CV as a PDF or TXT file.",
  },
  {
    name: "File & Link Story Reader",
    fileUpload: true,
    ...
    description:
      "Summarizes content from files and web links. Upload a PDF or TXT file to get started.",
  },
  {
    name: "Market Price Scanner",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="20" x2="12" y2="4"></line><polyline points="6 14 12 8 18 14"></polyline></svg>',
    description: "Scans and reports market prices for specified items.",
  },
  {
    name: "CV Roast + LinkedIn",
    ...
    description:
      "Provides constructive (and humorous) criticism on your CV and LinkedIn profile.",
  },
  {
    ...
    description: "Analyzes articles and sources to detect potential fake news.",
  },
  {
    ...
    description: "A supportive companion for mental wellness conversations.",
  },
  {
  ...
  },
  {
    ...
    description: "Helps identify and fix bugs in your code snippets.",
  },
  {
    name: "Language Tutor",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 17 17 23 15.79 13.88"></polyline></svg>',
    description:
      "Assists in learning new languages with practice and corrections.",
  },
  {
    ...
    description: "Tracks and categorizes your daily expenses.",
  },
  {
    name: "Travel Planner",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>',
    description: "Organizes your travel itineraries, from flights to hotels.",
  },
  {
    name: "Recipe Chef",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>',
    description:
      "Finds and adjusts recipes based on your ingredients and preferences.",
  },
  {
    name: "Workout Coach",
    ...
    description: "Creates personalized workout plans and tracks your progress.",
  },
  {
    ...
    description: "Simplifies complex legal jargon and concepts.",
  },
  {
    name: "SQL Optimizer",
    ...
    description: "Analyzes and suggests improvements for your SQL queries.",
  },
  {
    name: "Email Drafter",
    ...
    description:
      "Helps you write professional and effective emails for any situation.",
  },
  {
    name: "Study Quizzer",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',
    description: "Generates quizzes on any subject to help you study.",
  },
  {
    name: "Gift Matcher",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 12 20 22 4 22 4 12"></polyline><rect x="2" y="7" width="20" height="5"></rect><line x1="12" y1="22" x2="12" y2="7"></line><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"></path><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"></path></svg>',
    description:
      "Finds the perfect gift based on a person's interests and your budget.",
  },
  {
    name: "Dream Interpreter",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>',
    description: "Offers possible interpretations of your dreams.",
  },
  {
    name: "Plant Doctor",
    ...
    description: "Helps diagnose and treat problems with your house plants.",
  },
  {
    name: "Negotiation Coach",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>',
    description: "Provides tips and strategies for your upcoming negotiations.",
  },
  {
    name: "Horoscope & Mindset",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>',
    description: "Shares daily horoscopes and positive mindset affirmations.",
  },
  {
    name: "Movie Matcher",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"></rect><line x1="7" y1="2" x2="7" y2="22"></line><line x1="17" y1="2" x2="17" y2="22"></line><line x1="2" y1="12" x2="22" y2="12"></line><line x1="2" y1="7" x2="7" y2="7"></line><line x1="2" y1="17" x2="7" y2="17"></line><line x1="17" y1="17" x2="22" y2="17"></line><line x1="17" y1="7" x2="22" y2="7"></line></svg>',
    description: "Recommends movies and TV shows based on your taste.",
  },
  {
    ...
    description: "Translates modern slang into plain English.",
  },
  {
    name: "Joke Smith",
    ...
    description: "Writes and tells jokes on any topic you choose.",
  },
  {
    name: "Debate Partner",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="23"></line><line x1="8" y1="23" x2="16" y2="23"></line></svg>',
    description: "Engages in a structured debate with you on any topic.",
  },
  {
    name: "Time Zone Buddy",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>',
    description: "Helps you coordinate across different time zones.",
  },
  {
    name: "Habit Tracker",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>',
    description: "Monitors your daily habits and encourages consistency.",
  },
  {
    name: "Alias Generator",
    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="17" y1="11" x2="23" y2="11"></line></svg>',
    description: "Creates unique aliases and usernames for you.",
  },
  {
    name: "Local Guide",
    ...
    description:
      "Provides recommendations for restaurants, attractions, and events in your area.",
  },
...
app.post("/api/agent", upload.single("file"), async (req, res) => {
  ...
  if (!process.env.GEMINI_API_KEY) {
    return res
      .status(500)
      .json({ error: "Server is not configured with a Gemini API key." });
  }
  ...
  if (!agentId || (!prompt && !uploadedFile)) {
    return res
      ...
      .json({
        error:
          "An agent ID is required, and either a prompt or a file must be provided.",
      });
  }
  ...
  if (agent.id === "file-link-story-reader" && urls && urls.length > 0) {
    ...
    // Otherwise, check for a file upload
    try {
      let fileContent = "";
      if (uploadedFile.mimetype === "application/pdf") {
        ...
        // For now, we'll just inform the user about unsupported file types.
        fullPrompt = `[User tried to upload an unsupported file: ${uploadedFile.originalname} of type ${uploadedFile.mimetype}. Inform them that you can currently only process text and PDF files.]\n\n${prompt}`;
      }

      if (fileContent) {
        // Construct a detailed prompt for the AI
        fullPrompt = `The user has uploaded a file named "${uploadedFile.originalname}". Here is its content:\n\n--- FILE CONTENT START ---\n${fileContent}\n--- FILE CONTENT END ---\n\nNow, please respond to the following user prompt based on the file content:\n\n${prompt}`;
      }
    } catch (fileError) {
      ...
      chatHistories[agentId] = [
        {
          ...
          parts: [
            {
              text: `Your persona is '${agent.name}'. Your defined role is: "${agent.description}". You must strictly and exclusively act as this persona. Do not reveal you are an AI model.`,
            },
          ],
        },
        {
          role: "model",
          parts: [
            { text: `Okay, I understand. I will act as the ${agent.name}.` },
          ],
        },
      ];
    }
